...
void RegisterCnTaAshareFunctions(ExtensionLoader &loader) {
    ...
    loader.RegisterFunction(ScalarFunction("cn_limit_pct",
    ...
    loader.RegisterFunction(ScalarFunction("cn_change_pct",
                                           {LogicalType::DOUBLE, LogicalType::DOUBLE},
                                           LogicalType::DOUBLE, ChangePctFunc));

    // cn_turnover(volume, float_shares) -> DOUBLE
    loader.RegisterFunction(ScalarFunction("cn_turnover",
                                           {LogicalType::DOUBLE, LogicalType::DOUBLE},
                                           LogicalType::DOUBLE, TurnoverFunc));

    // cn_trading_day(date) -> BOOLEAN
    loader.RegisterFunction(ScalarFunction("cn_trading_day", {LogicalType::DATE}, LogicalType::BOOLEAN, TradingDayFunc));
    ...
    loader.RegisterFunction(ScalarFunction("cn_adjust_price",
                                           {LogicalType::DOUBLE, LogicalType::DOUBLE},
