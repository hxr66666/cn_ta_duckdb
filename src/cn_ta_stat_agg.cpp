...
void RegisterCnTaStatAggFunctions(ExtensionLoader &loader) {
	...
	loader.RegisterFunction(AggregateFunction(
	    "stat_avg", {LogicalType::DOUBLE}, LogicalType::DOUBLE, StatAggSingle<WinMean>::StateSize,
	    StatAggSingle<WinMean>::Initialize, StatAggSingle<WinMean>::Update, StatAggSingle<WinMean>::Combine,
	    StatAggSingle<WinMean>::Finalize, FunctionNullHandling::DEFAULT_NULL_HANDLING,
	    StatAggSingle<WinMean>::SimpleUpdate, nullptr, StatAggSingle<WinMean>::Destroy));
	loader.RegisterFunction(AggregateFunction(
	    "stat_sum", {LogicalType::DOUBLE}, LogicalType::DOUBLE, StatAggSingle<WinSum>::StateSize,
	    StatAggSingle<WinSum>::Initialize, StatAggSingle<WinSum>::Update, StatAggSingle<WinSum>::Combine,
	    StatAggSingle<WinSum>::Finalize, FunctionNullHandling::DEFAULT_NULL_HANDLING,
	    StatAggSingle<WinSum>::SimpleUpdate, nullptr, StatAggSingle<WinSum>::Destroy));
	loader.RegisterFunction(AggregateFunction(
	    "stat_min", {LogicalType::DOUBLE}, LogicalType::DOUBLE, StatAggSingle<WinMin>::StateSize,
	    StatAggSingle<WinMin>::Initialize, StatAggSingle<WinMin>::Update, StatAggSingle<WinMin>::Combine,
	    StatAggSingle<WinMin>::Finalize, FunctionNullHandling::DEFAULT_NULL_HANDLING,
	    StatAggSingle<WinMin>::SimpleUpdate, nullptr, StatAggSingle<WinMin>::Destroy));
	loader.RegisterFunction(AggregateFunction(
	    "stat_max", {LogicalType::DOUBLE}, LogicalType::DOUBLE, StatAggSingle<WinMax>::StateSize,
	    StatAggSingle<WinMax>::Initialize, StatAggSingle<WinMax>::Update, StatAggSingle<WinMax>::Combine,
	    StatAggSingle<WinMax>::Finalize, FunctionNullHandling::DEFAULT_NULL_HANDLING,
	    StatAggSingle<WinMax>::SimpleUpdate, nullptr, StatAggSingle<WinMax>::Destroy));
	loader.RegisterFunction(AggregateFunction(
	    "stat_momentum", {LogicalType::DOUBLE}, LogicalType::DOUBLE, StatAggSingle<WinMomentum>::StateSize,
	    StatAggSingle<WinMomentum>::Initialize, StatAggSingle<WinMomentum>::Update, StatAggSingle<WinMomentum>::Combine,
	    StatAggSingle<WinMomentum>::Finalize, FunctionNullHandling::DEFAULT_NULL_HANDLING,
	    StatAggSingle<WinMomentum>::SimpleUpdate, nullptr, StatAggSingle<WinMomentum>::Destroy));

	// 窗口方差/标准差（独立名字，避免与标量 stat_var/stat_stddev 冲突）
	loader.RegisterFunction(AggregateFunction(
	    "stat_rolling_var", {LogicalType::DOUBLE}, LogicalType::DOUBLE, StatAggSingle<WinVar>::StateSize,
	    StatAggSingle<WinVar>::Initialize, StatAggSingle<WinVar>::Update, StatAggSingle<WinVar>::Combine,
	    StatAggSingle<WinVar>::Finalize, FunctionNullHandling::DEFAULT_NULL_HANDLING,
	    StatAggSingle<WinVar>::SimpleUpdate, nullptr, StatAggSingle<WinVar>::Destroy));
	loader.RegisterFunction(AggregateFunction(
	    "stat_rolling_stddev", {LogicalType::DOUBLE}, LogicalType::DOUBLE, StatAggSingle<WinStddev>::StateSize,
	    StatAggSingle<WinStddev>::Initialize, StatAggSingle<WinStddev>::Update, StatAggSingle<WinStddev>::Combine,
	    StatAggSingle<WinStddev>::Finalize, FunctionNullHandling::DEFAULT_NULL_HANDLING,
	    StatAggSingle<WinStddev>::SimpleUpdate, nullptr, StatAggSingle<WinStddev>::Destroy));
	...
	loader.RegisterFunction(AggregateFunction(
	    ...
	    StatAggPair<WinBeta>::Combine, StatAggPair<WinBeta>::Finalize, FunctionNullHandling::DEFAULT_NULL_HANDLING,
	    StatAggPair<WinBeta>::SimpleUpdate, nullptr, StatAggPair<WinBeta>::Destroy));
	loader.RegisterFunction(AggregateFunction(
	    ...
	    StatAggPair<WinCorr>::Combine, StatAggPair<WinCorr>::Finalize, FunctionNullHandling::DEFAULT_NULL_HANDLING,
	    StatAggPair<WinCorr>::SimpleUpdate, nullptr, StatAggPair<WinCorr>::Destroy));
}
